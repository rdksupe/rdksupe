...
The pixel cat in [`profile-banner.svg`](./profile-banner.svg) is adapted from **clawd-umbrella** / **clawd-waving** in [clawd-pet](https://github.com/abderrahimghazali/clawd-pet) by [abderrahimghazali](https://github.com/abderrahimghazali), used under the [MIT License](https://github.com/abderrahimghazali/clawd-pet/blob/main/LICENSE).
